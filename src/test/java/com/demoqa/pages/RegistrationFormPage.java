...
public class RegistrationFormPage {
    ...
    public void checkFillsForm() {
        getStudentName.shouldHave(new Text(testData.firstName + " " + testData.lastName));
        getEmail.shouldHave(new Text(testData.email));
        getGender.shouldHave(new Text(testData.gender));
        getMobile.shouldHave(new Text(testData.mobile));
        getDateOfBirth.shouldHave(new Text(testData.updateDateOfBirth));
        getSubjects.shouldHave(new Text(testData.subjects));
        getHobbies.shouldHave(new Text(testData.strHobbies));
        getPicture.shouldHave(new Text(testData.picture));
        getCurrentAddress.shouldHave(new Text(testData.currentAddress));
        getStateAndCity.shouldHave(new Text(testData.state + " " + testData.city));
